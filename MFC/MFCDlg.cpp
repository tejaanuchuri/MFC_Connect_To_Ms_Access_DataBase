...
void CMFCDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, id_value);
	DDX_Control(pDX, IDC_EDIT2, name_control);
	DDX_Text(pDX, IDC_EDIT2, name_value);
	DDX_Control(pDX, IDC_EDIT3, age_control);
	DDX_Text(pDX, IDC_EDIT3, age_value);
}
...
void CMFCDlg::OnBnClickedOk()
{
	...
	CDatabase database;
	CString SqlString;
	CString strID = dlg.id_value, strName=dlg.name_value, strAge=dlg.age_value;
	//CString sDriver = L"MICROSOFT ACCESS DRIVER (*.accdb)";
	CString sDsn;
	//CString sFile = L"C:Test.accdb";
	...
	TRY{
		...
		CString out;
		SqlString = "INSERT INTO Emp (ID,Name,age) VALUES (9,'teja anuchuri',88)";
